 ...
 */
public class MethodLevelSecurityConfig implements PermissionEvaluator {

	private static final Log log = LogFactory.getLog(MethodLevelSecurityConfig.class);

	public MethodLevelSecurityConfig() {
		log.info("Created");
	}
