...
import com.yoogesh.common.web.LemonProperties.RemoteResource;
import com.yoogesh.security.filter.LemonTokenAuthenticationFilter;
import com.yoogesh.security.handler.AuthenticationSuccessHandler;
import com.yoogesh.security.principalExtractor.AbstractPrincipalExtractor;
import com.yoogesh.security.principalExtractor.LemonPrincipalExtractor;
...
public class SecurityApiConfig extends WebSecurityConfigurerAdapter {
	...
	private static final Log log = LogFactory.getLog(SecurityApiConfig.class);
