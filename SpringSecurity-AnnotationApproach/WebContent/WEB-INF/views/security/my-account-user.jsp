...
<title>my-account-User</title>
 <jsp:include page="/WEB-INF/views/theme/theme-include-my-account-user.jsp" />
</head>
<body>
...
<a href="${pageContext.request.contextPath}/my-account-user"> Go back to Home!!! </a> </br>
